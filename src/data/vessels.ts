...
export const vessels: Piece[] = [
  ...
  { slug: 'barriers-in-black-locust-3',         images: [{ src: vessel14, alt: 'Barriers In Black Locust' }, { src: vessel14b, alt: 'Barriers In Black Locust' }],          title: 'Barriers In Black Locust',        medium: 'Black Locust felled in Southfields, London SW18', year: '2025', dimensions: '36 × 28 cm', blurb: 'Turned, carved, burnt and waxed.', price: '£800' },
  { slug: 'barriers-in-locust',         images: [{ src: vessel15b, alt: 'Barriers In Locust' }, { src: vessel15, alt: 'Barriers In Locust' }],          title: 'Barriers In Locust',        medium: 'Black Locust felled in Southfields, London SW18', year: '2025', dimensions: '37 × 26 cm', blurb: 'Turned, carved, burnt and waxed.', price: '£700' },
  ...
  { slug: 'barriers-in-black-locust-4',           images: [{ src: vessel20, alt: 'Barriers In Black Locust' }, { src: vessel20b, alt: 'Barriers In Black Locust' }],             title: 'Barriers In Black Locust',           medium: 'Black Locust felled in Southfields, London SW18', year: '2026', dimensions: '35 × 28 cm', blurb: 'Turned, carved, burnt and waxed.', price: '£600' },
  { slug: 'barriers-in-maple-2', images: [{ src: vessel8, alt: 'Barriers in Maple' }, { src: vessel8b, alt: 'Barriers in Maple' }], title: 'Barriers in Maple', medium: 'Norwegian Maple Felled in Teddington, London', year: '2025', dimensions: '27 × 24 cm', blurb: 'Turned, carved, burnt and waxed.', price: '£500' },
