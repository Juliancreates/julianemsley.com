...
export const paintings: Piece[] = [
  ...
  { slug: 'charcoal-diptych',        images: [{ src: theLastFieldNew,  alt: 'The last field' }, { src: charcoalDiptych2, alt: 'The last field' }, { src: charcoalDiptych3, alt: 'The last field' }],          title: 'Charcoal Study',         medium: 'Paint, charcoal, resin on wood panel',                 year: '2025', dimensions: '85 × 45 cm framed x 2',  price: 'SOLD' },
];
