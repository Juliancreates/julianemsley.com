...
export const paintings: Piece[] = [
  { slug: 'smoke-series',             images: [{ src: slowFire4, alt: 'Slow fire' }],               video: '/images/smoke-series-triptych.mov', title: 'Smoke Series',              medium: 'Paint, charcoal, resin on wood panel',       year: '2025', dimensions: '105 × 55 cm framed x 3',  price: '£800 Each\n£2,000 for three' },
  ...
  { slug: 'inner-conflict',            images: [{ src: painting16, alt: 'Smoke line' }, { src: smokeLine2, alt: 'Smoke line' }],              title: 'Inner Conflict',             medium: 'Paint, charcoal, ink, wood, resin on wood panel',               year: '2025', dimensions: '105 × 50 cm framed', price: '£700' },
  { slug: 'conflict-series',           images: [{ src: painting15, alt: 'Pale ground' }, { src: paleGround2, alt: 'Pale ground' }, { src: paleGround3, alt: 'Pale ground' }],             title: 'Conflict Series',            medium: 'Paint, charcoal, ink, wood, resin on wood panel',           year: '2025', dimensions: '105 × 55 cm framed',  price: '£800' },
  { slug: 'charcoal-diptych',        images: [{ src: theLastFieldNew,  alt: 'The last field' }, { src: charcoalDiptych2, alt: 'The last field' }, { src: charcoalDiptych3, alt: 'The last field' }],          title: 'Charcoal Study',         medium: 'Paint, charcoal, resin on wood panel',                 year: '2025', dimensions: '85 × 45 cm framed x 2',  price: '£300 Each' },
];
